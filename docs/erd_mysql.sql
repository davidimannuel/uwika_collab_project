...
VALUES
(1, 1, 'Grocery shopping', 'expense', 50.000, NOW(), FALSE, NOW(), NOW()),
(2, 2, 'Salary deposit', 'income', 2000.000, NOW(), FALSE, NOW(), NOW()),
(3, 3, 'Flight tickets', 'expense', 150.000, NOW(), FALSE, NOW(), NOW()),
(4, 4, 'Medical bill', 'expense', 100.000, NOW(), TRUE, NOW(), NOW()),
(5, 5, 'Book purchase', 'expense', 30.000, NOW(), FALSE, NOW(), NOW()),
(6, 1, 'Online subscription', 'expense', 15.000, NOW(), FALSE, NOW(), NOW()),
(7, 2, 'Interest credit', 'income', 50.000, NOW(), FALSE, NOW(), NOW()),
(8, 3, 'Travel insurance', 'expense', 20.000, NOW(), FALSE, NOW(), NOW()),
(9, 4, 'Hospital visit', 'expense', 200.000, NOW(), TRUE, NOW(), NOW()),
(10, 5, 'Stock dividend', 'income', 500.000, NOW(), FALSE, NOW(), NOW());
...
VALUES
(1, 1, 'Monthly Groceries', 'expense', 500.000, 1000.000, NOW(), DATE_ADD(NOW(), INTERVAL 30 DAY), NOW(), NOW()),
(2, 2, 'Utility Bills', 'expense', 300.000, 600.000, NOW(), DATE_ADD(NOW(), INTERVAL 30 DAY), NOW(), NOW());
